  ...
  <div class="warpper">
    <div class="header">
      ...
      <div class="search_wrap">
        ...
        <el-button type="success" class="addStudent" @click="changeInfo('save')" :disabled="!classId">增加</el-button>
        <el-button type="primary" class="addStudent" @click="importStudent">批量导入</el-button>
      </div>
    </div>
...
<script>
  ...
  import infoApi from '../student/api'
  export default {
    data () {
      return {
        options: [],
    ...
    methods: {
      changeInfo (type, item, index) {
        ...
        if (this.type === 'edit') {
          ...
          this.index = index
          infoApi.getStudentInfo({schoolId: this.$route.params.schoolId, studentId: this.personInfo.studentId}, (data) => {
            this.studentInfo = {
      ...
      studentAdd () {
        ...
        if (this.type === 'save') {
          infoApi.addStudent({schoolId: this.$route.params.schoolId, info: this.studentInfo, classId: this.classId}, (data) => {
          ...
          infoApi.adminEditStudentInfo({schoolId: this.$route.params.schoolId, info: this.studentInfo, studentId: this.personInfo.studentId}, (data) => {
      ...
      deleteStudent (id, index) {
        infoApi.delStudent({schoolId: this.$route.params.schoolId, studentId: id, classId: this.classId}, (data) => {
