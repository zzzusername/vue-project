  ...
  <div>
    ...
    <div>
      <el-table  :data="list" border :max-height="maxHeight">
        ...
        <el-table-column label="科目" prop="subjectName" align="center" min-width="50"></el-table-column>
    ...
    <el-dialog :visible.sync="dialogVisible">
      <el-form ref="form" :model="form">
        <el-form-item label="科目" label-width="100px">
          <el-input v-model="form.subjectName" style="width:40%"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    onRefresh () {
      api.getElectiveOneList({schoolId: this.$route.params.schoolId, studentId: this.$route.params.studentId, classId: this.$route.params.classId, reportId: this.$route.params.reportId}, (data) => {
        this.list = data
      }, () => {})
    },
    onAdd () {
    ...
    onSave () {
      if (this.tools.isNull(this.form.subjectName)) {
        this.warnMessage('请填写科目')
        return
      }
      ...
      api.saveElectiveOne({schoolId: this.$route.params.schoolId, studentId: this.$route.params.studentId, classId: this.$route.params.classId, reportId: this.$route.params.reportId, data}, (data) => {
    ...
    onEdit (item) {
      api.getElectiveOneInfo({schoolId: this.$route.params.schoolId, studentId: this.$route.params.studentId, classId: this.$route.params.classId, reportId: this.$route.params.reportId, electiveId: item.electiveId}, (data) => {
        this.form = data
        this.dialogVisible = true
      }, () => {})
    }
