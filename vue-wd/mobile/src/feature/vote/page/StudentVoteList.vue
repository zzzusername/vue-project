...
export default {
  ...
  methods: {
    infinite(done) {
      this.getStudentVoteList(this.voteList.length, (data) => {
    ...
    getStudentVoteList (rowStart, callback) {
      var rowCount = 20
      api.getStudentVoteList({schoolId: this.$route.params.schoolId, studentId: this.$route.params.studentId, rowStart, rowCount}, (data) => {
